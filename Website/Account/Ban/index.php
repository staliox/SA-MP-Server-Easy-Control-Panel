...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
     if ($_POST['nameid']) {
          $query = $s_con->prepare("UPDATE `data` SET `Data_ID`='4', `Data_Name`=? WHERE `ID`=1");
          $query->execute(array($_POST['nameid']));
          $result['ex_msg'] = "بازیکن مورد نظر با موفقیت از سرور محروم شد.";
          $result['ex'] = true;
     } else {
          ...
          <div class="container-login100" style="background-image: url('../../images/img-01.jpg');">
               <div class="wrap-login100 p-t-190 p-b-30">
                    <form action="" method="post" class="login100-form validate-form">
                         ...
                         <div class="wrap-input100 validate-input m-b-10" data-validate="لطفا نام یا آیدی پلیر مورد نظر را بنویسید">
                              <input class="input100" type="text" name="nameid" placeholder="Name Or GameID">
