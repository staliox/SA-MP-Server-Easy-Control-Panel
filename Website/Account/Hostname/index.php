...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
     if ($_POST['hostname']) {
          $query = $s_con->prepare("UPDATE `data` SET `Data_ID`='1', `Data_Name`=? WHERE `ID`=1");
          $query->execute(array($_POST['hostname']));
          $result['ex'] = true;
          $result['ex_msg'] = "نام سرور با موفقیت تغییر کرد";
     } else {
          ...
          <div class="container-login100" style="background-image: url('../../images/img-01.jpg');">
               <div class="wrap-login100 p-t-190 p-b-30">
                    <form action="" method="post" class="login100-form validate-form">
                         ...
                         <div class="wrap-input100 validate-input m-b-10" data-validate="لطفا نام سرور را وارد کنید">
                              <input class="input100" type="text" name="hostname" placeholder="Hostname">
